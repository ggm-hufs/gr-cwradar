...
class CW_Radar_Simulator_Multiple_Targets(grc_wxgui.top_block_gui):
    ...
    def set_samp_rate(self, samp_rate):
        self.samp_rate = samp_rate
        self.throtle_block.set_sample_rate(self.samp_rate)
        self.tx_signal.set_sampling_freq(self.samp_rate)
        self.rx_signal_0.set_sampling_freq(self.samp_rate)
        self.rx_signal_1.set_sampling_freq(self.samp_rate)
        self.rx_signal_2.set_sampling_freq(self.samp_rate)
        self.wxgui_fftsink2_full_spectrum.set_sample_rate(self.samp_rate)
        self.cwradar_doppler_velocity_multiple_targets_ff.set_samples_per_sec(self.samp_rate)
    ...
    def set_fft_len(self, fft_len):
        self.fft_len = fft_len
        self.keep_m_in_n_positive.set_offset(self.fft_len/2)
        self.keep_m_in_n_positive.set_m(self.fft_len/2)
        self.keep_m_in_n_positive.set_n(self.fft_len)
        self.keep_m_in_n_negative.set_m(self.fft_len/2)
        self.keep_m_in_n_negative.set_n(self.fft_len)
        self.DC_filter_positive.set_k(([0]*self.DC_filter_num_elements+[1]*((self.fft_len/2)-self.DC_filter_num_elements)))
        self.DC_filter_negative.set_k(([0]*self.DC_filter_num_elements+[1]*((self.fft_len/2)-self.DC_filter_num_elements)))
    ...
    def set_samp_rate_sink(self, samp_rate_sink):
        self.samp_rate_sink = samp_rate_sink
        self.wxgui_fftsink2.set_sample_rate(self.samp_rate_sink)
        self.wxgui_waterfallsink2_time_frequency.set_sample_rate(self.samp_rate_sink)
    ...
    def set_tx_amp(self, tx_amp):
        self.tx_amp = tx_amp
        self.rx_signal_1.set_amplitude(self.tx_amp+10e-3)
    ...
    def set_tx_amp_tuner(self, tx_amp_tuner):
        ...
        self.rx_signal_2.set_amplitude(self.tx_amp_tuner-5e-3)
    ...
    def set_threshold_dB_tuner(self, threshold_dB_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_signal_min_dB(self.threshold_dB_tuner)
    ...
    def set_max_num_of_targets_tuner(self, max_num_of_targets_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_max_num_of_targets(self.max_num_of_targets_tuner)
    ...
    def set_lowpass_cutoff_freq_tuner(self, lowpass_cutoff_freq_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_lowpass_cut_freq(self.lowpass_cutoff_freq_tuner)
    ...
    def set_highpass_cutoff_freq_tuner(self, highpass_cutoff_freq_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_highpass_cut_freq(self.highpass_cutoff_freq_tuner)
    ...
    def set_doppler_signal_bw_tuner(self, doppler_signal_bw_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_doppler_signal_bw(self.doppler_signal_bw_tuner)
    ...
    def set_doppler_freq_sim_tuner(self, doppler_freq_sim_tuner):
        ...
        self.rx_signal_1.set_frequency(self.doppler_freq_sim_tuner-1300)
        self.rx_signal_2.set_frequency(self.doppler_freq_sim_tuner+15)
    ...
    def set_angle_tuner(self, angle_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_angle_of_approach(self.angle_tuner)
    ...
    def set_RF_tuner(self, RF_tuner):
        ...
        self.cwradar_doppler_velocity_multiple_targets_ff.set_radar_freq(self.RF_tuner)
...
if __name__ == '__main__':
    ...
    tb = CW_Radar_Simulator_Multiple_Targets(angle=options.angle, samp_rate=options.samp_rate, fft_len=options.fft_len, samp_rate_sink=options.samp_rate_sink, tx_amp=options.tx_amp, max_num_of_targets=options.max_num_of_targets, lowpass_cutoff_freq=options.lowpass_cutoff_freq, RF=options.RF, speed_samp_rate=options.speed_samp_rate, DC_filter_num_elements=options.DC_filter_num_elements, threshold_dB=options.threshold_dB, rx_gain=options.rx_gain, highpass_cutoff_freq=options.highpass_cutoff_freq, doppler_signal_bw=options.doppler_signal_bw)
    tb.Start(True)
    tb.Wait()
