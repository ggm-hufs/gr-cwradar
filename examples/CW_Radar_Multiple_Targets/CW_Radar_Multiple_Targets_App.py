...
# Generated: Tue Nov 25 19:28:31 2014
##################################################
...
class CW_Radar_Multiple_Targets(grc_wxgui.top_block_gui):

    def __init__(self, DC_filter_num_elements=4, samp_rate_sink=8000, lo_offset_freq=1e6, highpass_cutoff_freq=0, doppler_signal_bw=20, rx_gain=30.5, tx_amp=1, max_num_of_targets=10, angle=0, speed_samp_rate=1, lowpass_cutoff_freq=1700, fft_len=pow(2,20), RF=2.49e9, samp_rate=1e6, threshold_dB=-70):
        grc_wxgui.top_block_gui.__init__(self, title="CW Radar Multiple Targets")
...
if __name__ == '__main__':
    ...
    tb = CW_Radar_Multiple_Targets(DC_filter_num_elements=options.DC_filter_num_elements, samp_rate_sink=options.samp_rate_sink, lo_offset_freq=options.lo_offset_freq, highpass_cutoff_freq=options.highpass_cutoff_freq, doppler_signal_bw=options.doppler_signal_bw, rx_gain=options.rx_gain, tx_amp=options.tx_amp, max_num_of_targets=options.max_num_of_targets, angle=options.angle, speed_samp_rate=options.speed_samp_rate, lowpass_cutoff_freq=options.lowpass_cutoff_freq, fft_len=options.fft_len, RF=options.RF, samp_rate=options.samp_rate, threshold_dB=options.threshold_dB)
    tb.Start(True)
    tb.Wait()
